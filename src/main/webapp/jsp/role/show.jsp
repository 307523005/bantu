...
<html>
  ...
  <body>
    ...
    <div class="easyui-panel" id="tt" style="padding:0px 0px 0px 20px;border: 0px;">
		<ul class="easyui-tree" data-options="url:'role/getAllRole.do',method:'post',animate:true,lines:true,dnd: true"></ul>
	</div>
		...
		$(function(){
			$("#tt ul").tree({
				onClick: function(node){
					...
					window.parent.rightFrame.location.href="role/toUpdate.do?id="+node.id;
				},
