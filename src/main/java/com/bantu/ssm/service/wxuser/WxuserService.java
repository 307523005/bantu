package com.bantu.ssm.service.wxuser;
 ...
 * @return
 */
public Map  getList(Wxuser wxuser)throws Exception;
/**
 * 添加用户信息
 * @param wxuser
 * @return
 ...
 * @return
 */
public List<Wxuser> getByOpenid(String openid)throws Exception;
/**
 * 修改用户信息
 * @param wxuser
 * @return
...
public List<AccessToken> getAccessToken(AccessToken accessToken)throws Exception;
public String gettemplatemessage(TemplateMessage accessToken)
		throws Exception;
}
