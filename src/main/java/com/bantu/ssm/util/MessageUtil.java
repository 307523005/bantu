...
import com.bantu.ssm.entity.wx.Transfers;
...
public class MessageUtil {
	...
	public static String messageToXML(Payment payment) {
		xstream.alias("xml", Payment.class);
		return xstream.toXML(payment);
	}

	public static String refundPayToXML(RefundPay refundPay) {
		xstream.alias("xml", RefundPay.class);
		return xstream.toXML(refundPay);
	}
